...
namespace ETS_Lib
{
    public class ETS_Manager
    {
        ...
        {
            string allInfo = "";
            using (StreamReader sr = new StreamReader(@"..\..\..\Files\Donations.txt"))
            {
                while (sr.Peek() >= 0)
                {
                    string str;
        ...
        {
            using (StreamWriter sw = new StreamWriter(@"..\..\..\Files\Donors.txt", append: true))
            {
        ...
        {
            using (StreamWriter sw = new StreamWriter(@"..\..\..\Files\Donations.txt", append: true))
            {
        ...
        {
            using (StreamWriter sw = new StreamWriter(@"..\..\..\Files\Sponsors.txt", append: true))
            {
        ...
        {
            using (StreamWriter sw = new StreamWriter(@"..\..\..\Files\Prizes.txt", append: true))
            {
        ...
        public int getDonorIndex(string donID)
        {
            int index = 0;
            foreach (Donor donor in myDonors)
            {
        ...
        public void deleteDonor(string donID)
        {
            //string message = "";
            if (donorVerifier(donID) == false)
            {
